...
{
    template <typename L, typename R>
    bool binary_arg_use(const DOCTEST_REF_WRAP(L), const DOCTEST_REF_WRAP(R)) {
        return false;
    }

    struct streaming_operator_use
    {
        template <typename T>
        streaming_operator_use& operator<<(const T&) {
            return *this;
        }
    };
} // namespace detail
...
#define DOCTEST_INFO(x) ((void)sizeof(doctest::detail::streaming_operator_use() << x))
#define DOCTEST_CAPTURE(x) ((void)sizeof(doctest::detail::streaming_operator_use() << x))
#define DOCTEST_ADD_MESSAGE_AT(file, line, x) ((void)sizeof(doctest::detail::streaming_operator_use() << x))
#define DOCTEST_ADD_FAIL_CHECK_AT(file, line, x) ((void)sizeof(doctest::detail::streaming_operator_use() << x))
#define DOCTEST_ADD_FAIL_AT(file, line, x) ((void)sizeof(doctest::detail::streaming_operator_use() << x))
#define DOCTEST_MESSAGE(x) ((void)sizeof(doctest::detail::streaming_operator_use() << x))
#define DOCTEST_FAIL_CHECK(x) ((void)sizeof(doctest::detail::streaming_operator_use() << x))
#define DOCTEST_FAIL(x) ((void)sizeof(doctest::detail::streaming_operator_use() << x))

#ifdef DOCTEST_CONFIG_WITH_VARIADIC_MACROS
#define DOCTEST_WARN(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_CHECK(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_REQUIRE(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_WARN_FALSE(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_CHECK_FALSE(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_REQUIRE_FALSE(...) ((void)sizeof(__VA_ARGS__))
#else // DOCTEST_CONFIG_WITH_VARIADIC_MACROS
#define DOCTEST_WARN(expr) ((void)sizeof(expr))
#define DOCTEST_CHECK(expr) ((void)sizeof(expr))
#define DOCTEST_REQUIRE(expr) ((void)sizeof(expr))
#define DOCTEST_WARN_FALSE(expr) ((void)sizeof(expr))
#define DOCTEST_CHECK_FALSE(expr) ((void)sizeof(expr))
#define DOCTEST_REQUIRE_FALSE(expr) ((void)sizeof(expr))
#endif // DOCTEST_CONFIG_WITH_VARIADIC_MACROS

#define DOCTEST_WARN_MESSAGE(cond, msg) ((void)sizeof(cond));((void)sizeof(doctest::detail::streaming_operator_use() << msg))
#define DOCTEST_CHECK_MESSAGE(cond, msg) ((void)sizeof(cond));((void)sizeof(doctest::detail::streaming_operator_use() << msg))
#define DOCTEST_REQUIRE_MESSAGE(cond, msg) ((void)sizeof(cond));((void)sizeof(doctest::detail::streaming_operator_use() << msg))
#define DOCTEST_WARN_FALSE_MESSAGE(cond, msg) ((void)sizeof(cond));((void)sizeof(doctest::detail::streaming_operator_use() << msg))
#define DOCTEST_CHECK_FALSE_MESSAGE(cond, msg) ((void)sizeof(cond));((void)sizeof(doctest::detail::streaming_operator_use() << msg))
#define DOCTEST_REQUIRE_FALSE_MESSAGE(cond, msg) ((void)sizeof(cond));((void)sizeof(doctest::detail::streaming_operator_use() << msg))
...
#define DOCTEST_WARN_EQ(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_CHECK_EQ(...) ((void)0)
//#define DOCTEST_CHECK_EQ(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_REQUIRE_EQ(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_WARN_NE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_CHECK_NE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_REQUIRE_NE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_WARN_GT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_CHECK_GT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_REQUIRE_GT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_WARN_LT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_CHECK_LT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_REQUIRE_LT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_WARN_GE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_CHECK_GE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_REQUIRE_GE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_WARN_LE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_CHECK_LE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_REQUIRE_LE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))

#define DOCTEST_WARN_UNARY(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_CHECK_UNARY(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_REQUIRE_UNARY(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_WARN_UNARY_FALSE(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_CHECK_UNARY_FALSE(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_REQUIRE_UNARY_FALSE(...) ((void)sizeof(__VA_ARGS__))

#define DOCTEST_FAST_WARN_EQ(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_CHECK_EQ(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_REQUIRE_EQ(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_WARN_NE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_CHECK_NE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_REQUIRE_NE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_WARN_GT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_CHECK_GT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_REQUIRE_GT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_WARN_LT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_CHECK_LT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_REQUIRE_LT(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_WARN_GE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_CHECK_GE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_REQUIRE_GE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_WARN_LE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_CHECK_LE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))
#define DOCTEST_FAST_REQUIRE_LE(...) ((void)sizeof(doctest::detail::binary_arg_use(__VA_ARGS__)))

#define DOCTEST_FAST_WARN_UNARY(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_FAST_CHECK_UNARY(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_FAST_REQUIRE_UNARY(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_FAST_WARN_UNARY_FALSE(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_FAST_CHECK_UNARY_FALSE(...) ((void)sizeof(__VA_ARGS__))
#define DOCTEST_FAST_REQUIRE_UNARY_FALSE(...) ((void)sizeof(__VA_ARGS__))

#else // DOCTEST_CONFIG_WITH_VARIADIC_MACROS

#define DOCTEST_WARN_EQ(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_CHECK_EQ(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_REQUIRE_EQ(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_WARN_NE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_CHECK_NE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_REQUIRE_NE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_WARN_GT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_CHECK_GT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_REQUIRE_GT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_WARN_LT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_CHECK_LT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_REQUIRE_LT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_WARN_GE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_CHECK_GE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_REQUIRE_GE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_WARN_LE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_CHECK_LE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_REQUIRE_LE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))

#define DOCTEST_WARN_UNARY(val) ((void)sizeof(val))
#define DOCTEST_CHECK_UNARY(val) ((void)sizeof(val))
#define DOCTEST_REQUIRE_UNARY(val) ((void)sizeof(val))
#define DOCTEST_WARN_UNARY_FALSE(val) ((void)sizeof(val))
#define DOCTEST_CHECK_UNARY_FALSE(val) ((void)sizeof(val))
#define DOCTEST_REQUIRE_UNARY_FALSE(val) ((void)sizeof(val))

#define DOCTEST_FAST_WARN_EQ(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_CHECK_EQ(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_REQUIRE_EQ(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_WARN_NE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_CHECK_NE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_REQUIRE_NE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_WARN_GT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_CHECK_GT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_REQUIRE_GT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_WARN_LT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_CHECK_LT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_REQUIRE_LT(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_WARN_GE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_CHECK_GE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_REQUIRE_GE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_WARN_LE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_CHECK_LE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))
#define DOCTEST_FAST_REQUIRE_LE(lhs, rhs) ((void)sizeof(doctest::detail::binary_arg_use(lhs, rhs)))

#define DOCTEST_FAST_WARN_UNARY(val) ((void)sizeof(val))
#define DOCTEST_FAST_CHECK_UNARY(val) ((void)sizeof(val))
#define DOCTEST_FAST_REQUIRE_UNARY(val) ((void)sizeof(val))
#define DOCTEST_FAST_WARN_UNARY_FALSE(val) ((void)sizeof(val))
#define DOCTEST_FAST_CHECK_UNARY_FALSE(val) ((void)sizeof(val))
#define DOCTEST_FAST_REQUIRE_UNARY_FALSE(val) ((void)sizeof(val))
